...
```bash
clan-tracker-pull-clan-data$ sam build
```
...
```bash
clan-tracker-pull-clan-data$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
clan-tracker-pull-clan-data$ sam logs -n HelloWorldFunction --stack-name clan-tracker-pull-clan-data --tail
```
...
```bash
clan-tracker-pull-clan-data$ pip install pytest pytest-mock --user
clan-tracker-pull-clan-data$ python -m pytest tests/ -v
```
...
```bash
aws cloudformation delete-stack --stack-name clan-tracker-pull-clan-data
```
